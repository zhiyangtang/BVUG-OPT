...
class STPG {
    ...
    void batchAnswer(Time t_fend);
    void batchAnswer2(Time t_fbegin);
    ...
    VertexID s, t;
    Time t_begin, t_end, tfend, tmfend, tfbegin, tmfbegin;
    VertexID *dropflag;
    EdgeID *polarityPointer, tpgEnd, newtpgEnd;
    bool *inQueue;
    PerEdge *tpg_graph, *newtpg_graph;
